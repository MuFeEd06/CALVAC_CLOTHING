...
export default async function AccountPage() {
  ...
  return (
    <>
      ...
      <main className="account-page" style={{ minHeight: '100vh', background: '#f5f5f3', paddingTop: 100, fontFamily: 'Barlow, sans-serif' }}>
        <div className="account-shell" style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px' }}>
          ...
          <div className="account-summary-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>

            {/* Profile card */}
            <div className="account-card" style={{ background: '#fff', borderRadius: 20, padding: 28 }}>
              ...
              <div className="account-profile-row" style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
            ...
            {/* Quick stats */}
            <div className="account-stat-stack" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div className="account-card" style={{ background: '#0d0d0d', borderRadius: 20, padding: 28, color: '#fff', flex: 1 }}>
              ...
              <Link className="account-card" href="/account/orders" style={{ background: '#f04e0f', borderRadius: 20, padding: 20, color: '#fff', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          {recentOrders && recentOrders.length > 0 && (
            <div className="account-card" style={{ background: '#fff', borderRadius: 20, padding: 28, marginTop: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {recentOrders.map((order: any) => (
                  <div className="account-order-row" key={order.id} style={{ border: '1px solid #f0f0ee', borderRadius: 12, padding: '14px 18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <div className="account-order-total" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
