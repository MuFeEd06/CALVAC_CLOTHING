      ...
      {el.type === 'image' && (
        <>
          <PropRow label="Image">
            {el.imageUrl ? (
              <div style={{ position: 'relative', marginBottom: 8 }}>
                <img src={el.imageUrl} alt="" style={{ width: '100%', height: 100, objectFit: 'cover', objectPosition: 'top center', borderRadius: 8 }} />
                  ...
                  {categoryItems.map((cat) => (
                    <div key={cat.id} style={{ border: `1.5px solid ${selectedCatId === cat.id ? '#f04e0f' : '#e8e8e5'}`, borderRadius: 8, marginBottom: 8, overflow: 'hidden', opacity: cat.visible ? 1 : 0.45 }}>
                      <div onClick={() => setSelectedCatId(cat.id === selectedCatId ? null : cat.id)} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 10px', background: selectedCatId === cat.id ? '#fff8f6' : '#fff', cursor: 'pointer' }}>
                        ...
                        <div style={{ width: 32, height: 32, borderRadius: 4, background: cat.imageUrl ? `url(${cat.imageUrl}) center top/cover` : '#e8e8e5', flexShrink: 0, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                          ...
                          <div>
                            ...
                            {cat.imageUrl ? (
                              <div style={{ position: 'relative' }}>
                                <img src={cat.imageUrl} alt="" style={{ width: '100%', height: 80, objectFit: 'cover', objectPosition: 'top center', borderRadius: 6 }} />
